...
def test_documentation_exists():
    ...
    guides = ["getting-started.md", "wiki-gitbook-guide.md", "repository-management.md"]
...
def test_bash_scripts_exist():
    ...
    scripts = ["delete-repo.sh", "repo-manager.sh"]
...
def test_no_duplicate_functionality():
    ...
    old_files = ["launcher.old.py", "DELETE-REPO-README.md"]
